    ...
    <div className="col-lg-12">
      <div className="card" style={{ margin: "15px", padding: "15px" }}>
        <div className="card-header align-items-center d-flex">
          <h1 className="card-title  flex-grow-1 ">Manage Vendor</h1>
        </div>
        <div>
                ...
                <div className="live-preview">
                  <div className="row g-3">
                    {/* <div className="col-sm-4">
                                            <label htmlFor={`vehicleTypeInput-${index}`} className="form-label">Offer Type</label>
                                            <Autocomplete
                                                id={`vehicleTypeInput-${index}`}
                                                sx={{ width: "100%" }}
                                                size='small'
                                                options={[
                                                    { label: 'Indian Package' },
                                                ...
                                                onChange={(e, newValue) => handleInputChange(index, 'vehicleType', newValue)}
                                                required
