    ...
    <div className="col-lg-12">
      <div className="card" style={{ margin: "15px", padding: "15px" }}>
        <div className="card-header align-items-center d-flex">
          <h1 className="card-title  flex-grow-1 ">Add Vehicle</h1>
        </div>
        <div>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-sm-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange(index, "inventory", e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div className="col-sm-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange(index, "seatLimit", e.target.value)
                        }
                      />
                    </div>
                    <div className="col-sm-4">
                      <label
                        htmlFor={`luggageCapacityInput-${index}`}
                        className="form-label"
                      >
                        Luggage Capacity
                      </label>
