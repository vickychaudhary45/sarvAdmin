    ...
    <div className="col-lg-12">
      <div className="card" style={{ margin: "15px", padding: "15px" }}>
        <div className="card-header align-items-center d-flex">
          <h1 className="card-title  flex-grow-1 ">Manage Seasonality</h1>
        </div>
        <div>
              ...
              <div className="card-body">
                <div className="live-preview">
                  <div className="row g-3">
                        ...
                        <DatePicker
                          ...
                          renderInput={(params) => (
                            <TextField
                              ...
                              size="small"
                              variant="outlined"
                              style={{ width: "120px", height: "35px" }} // Adjust the width and height as needed
                            />
                          )}
                          // style={{ width: '120px' }}
                        />
                    ...
                    <div className="col-sm-4">
                      <label className="form-label">Availability Date To</label>
                      <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DatePicker
                          format="DD-MM-YYYY"
                          // sx={{}}
                    ...
                    {/* <div className="col-sm-4">
                                            <label htmlFor={`brandNameInput-${index}`} className="form-label">Driver Name</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                ...
                                                onChange={(e) => handleInputChange(index, 'brandName', e.target.value)}
                                            />
                                        </div> */}
                    {/* <div className="col-sm-4">
                                            <label for="firstNameinput" className="form-label">Images</label>
                                            <input
                                                type="file"
                                                className="form-control"
                                                id="imagesInput"
